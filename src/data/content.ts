...
export const FAQ: FAQItem[] = [
  ...
  },
  {
    ...
    answer: `Да, рассрочка на ${COURSE.installmentMonths} месяцев без переплат. Социальный налоговый вычет ${COURSE.taxDeduction} на обучение (ст. 219 НК РФ) применяется после получения организацией образовательной лицензии — актуальный статус см. на странице «Лицензия».`,
  },
  {
