      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {items.map((item, i) => (
            <div
              key={i}
              className="group relative p-6 bg-white/[0.03] backdrop-blur-sm border border-white/5 hover:border-gold/30 transition-all duration-500"
            >
              ...
              <div className="relative z-10">
                <svg className="w-8 h-8 text-gold mb-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
