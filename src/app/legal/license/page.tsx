  ...
  return (
    ...
    >
      ...
      <ul className="space-y-2 ml-4 list-disc">
        ...
        <li>
          выдача сертификата о прохождении программы (во всех тарифах) и удостоверения о повышении
          квалификации (для тарифов «Практик» и «Внедрение»); сертификат подтверждает факт прохождения
          программы и не является документом об образовании государственного образца;
        </li>
        <li>
